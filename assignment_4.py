...
# 18-19: Check that if conditional was greater than or equal to 100 and if number_of_feet was less than 250, then declare and assign cost_per_feet to be .80
# 20-21: Used elif if first conditional evaluates to false, checked number_of_feet was greater than or equal to 250 and if number_of_feet was less than 500, assign cost_per_feet to be .70
# 22-23: Used elif if first and second conditions evaluates to false, checked number_of_feet was greater than or equal to 500, if it evaluates to true, assign cost_per_feet to be .50
